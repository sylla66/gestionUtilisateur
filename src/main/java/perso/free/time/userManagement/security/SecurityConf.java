...
public class SecurityConf {
    ...
    public SecurityConf(JwtFilter jwtFilter, BCryptPasswordEncoder bCryptPasswordEncoder) {
                        ...
                        .authorizeHttpRequests(
                                authorize->
                                        authorize
                                                ...
                                                .requestMatchers(GET,"/avis/all").hasAnyAuthority("ROLE_ADMIN","ROLE_MANAGER")
